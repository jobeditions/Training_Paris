        ...
        <div class="container">
            <div class="content-fixer">
                <div class="content-holder">
                    <h2>Conditions générales d'utilisation du site www.teacherhawk.com</h2>

                    <h4>ARTICLE 1 : Objet</h4>
                    <p>
                        Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique des
                        modalités de mise à disposition des services du site TeacherHawk et leur utilisation par «
                        l'Utilisateur ».
                        ...
                        www.teacherhawk.com se réserve le droit de modifier unilatéralement et à tout moment le contenu
                        des présentes conditions générales d'utilisation.
                    </p>

                    <h4>ARTICLE 2 : Mentions légales</h4>
                    <p> L'édition du site www.teacherhawk.com est assurée par la Société Liigem SARL au capital de 1500
                        € dont le siège social est situé au 4 Avenue du Marechal de Lattre Tassigny - 92210 Saint Cloud.<br/>
                        L'hébergeur du site www.teacherhawk.com est la Société Digital Ocean Inc. dont le siège social
                        est situé au 101 Avenue of The Americas Fl 10
                        New York.</p>

                    <h4>ARTICLE 3 : Définitions</h4>
                    <p> La présente clause a pour objet de définir les différents termes essentiels du contrat :</p>
                    <ul>
                        <li><strong>Utilisateur</strong>: ce terme désigne toute personne qui utilise le site ou l'un des services
                            proposés par le site.
                        </li>
                        <li><strong>Contenu utilisateur</strong> : ce sont les données transmises par l'Utilisateur au sein du site.</li>
                        <li><strong>Membre</strong> : l'Utilisateur devient membre lorsqu'il est identifié sur le site.</li>
                        <li><strong>Identifiant et mot de passe</strong> : c'est l'ensemble des informations nécessaires à
                            l'identification d'un Utilisateur sur le site. L'identifiant et le mot de passe permettent à
                            l'Utilisateur d'accéder à des services réservés aux membres du site. Le mot de passe est
                            confidentiel.
                        </li>
                    </ul>
                    ...
                    <p>
                        ...
                        réseau ou du serveur n'engage pas la responsabilité de TeacherHawk.<br/>
                    ...
                    <p> Les marques, logos, signes et tout autre contenu du site font l'objet d'une protection par le
                        ...
                        à la suppression ou à la modification du contenu Utilisateur.
                    </p>

                    <h4>ARTICLE 6 : Données personnelles</h4>
                    <p> Les informations demandées à l’inscription au site sont nécessaires et obligatoires pour la
                        ...
                        L'Utilisateur exerce ce droit via son espace personnel ou par mail à contact@liigem.io
                    </p>

                    <h4>ARTICLE 7 : Responsabilité et force majeure</h4>
                    <p>Les sources des informations diffusées sur le site sont réputées fiables. Toutefois, le site se
                        ...
                        responsabilité
                        de l'utilisation des informations et contenus du présent site.
                    ...
                    <p>
                        ...
                        mènent
                        ces liens n'engagent en rien la responsabilité de TeacherHawk qui n'a pas le contrôle de ces
                        liens. <br/>
                    ...
                    <p>La législation française s'applique au présent contrat. En cas d'absence de résolution amiable
                        d'un
                        litige né entre les parties, seuls les tribunaux de la ville de Paris sont compétents.
                    </p>

                    <h4> ARTICLE 12 : Publication par l’Utilisateur</h4>
                    <p>Le site permet aux membres de publier des œuvres personnelles.
                        Dans ses publications, le membre s’engage à respecter les règles de la Netiquette et les règles
                        de
                        droit en vigueur.
                        Le site peut exercer une modération a posteriori sur les publications et se réserve le droit
                        de refuser leur mise en ligne, sans avoir à s’en justifier auprès du membre. <br/>
                        ...
                        gratuit
                        de représenter, reproduire, adapter, modifier, diffuser et distribuer sa publication,
                        directement ou
                        par un tiers autorisé, dans le monde entier, sur tout support (numérique ou physique), pour la
                        durée
                        de la propriété intellectuelle. Le Membre cède notamment le droit d'utiliser sa publication sur
                        internet et sur les réseaux de téléphonie mobile.<br/>
