...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top m-b-0">
        <div class="navbar-header"><a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)"
            ...
            <div class="top-left-part"><a class="logo" href="{{ url('teacher') }}"><img
                            src="/teacheroffice/img/logo.png" alt="home" style="max-height:60px;"/></a></div>
            ...
            <ul class="nav navbar-top-links navbar-right pull-right">
                ...
                <li>
                    <a class="dropdown-toggle profile-pic" href="#"> <img
                                src="{{ url('storage/avatars/'.Auth::user()->avatar) }}" alt="user-img" width="36"
                                class="img-circle"><b
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse slimscrollsidebar">
            <ul class="nav" id="side-menu">
                <li class="user-pro">
                    <a href="#" class="waves-effect"><img src="{{ url('storage/avatars/'.Auth::user()->avatar) }}"
                                                          alt="user-img"
                ...
                <li><a href="{{ url('teacher/dashboard') }}" class="waves-effect"><i
                                class="zmdi zmdi-home zmdi-hc-fw fa-fw"></i> <span
                                class="hide-menu">Tableau de bord</span></a></li>
                <li><a href="{{ url('teacher/assignments') }}" class="waves-effect"><i
                                class="zmdi zmdi-assignment zmdi-hc-fw fa-fw"></i> <span
                                class="hide-menu">Mes Devoirs</span></a></li>
                <li><a href="{{ url('teacher/documents') }}" class="waves-effect"><i
                                class="zmdi zmdi-folder zmdi-hc-fw fa-fw"></i> <span
                                class="hide-menu">Mes Documents</span></a></li>
                <li><a href="{{ url('teacher/classes') }}" class="waves-effect"><i
                                class="zmdi zmdi-accounts zmdi-hc-fw fa-fw"></i> <span
                                class="hide-menu">Mes Classes</span></a></li>
                <li><a href="{{ url('teacher/notes') }}" class="waves-effect"><i
                                class="zmdi zmdi-labels zmdi-hc-fw fa-fw"></i> <span
                                class="hide-menu">Mes Notes</span></a></li>
                <li><a href="{{ url('teacher/reviews') }}" class="waves-effect"><i
                                class="zmdi zmdi-thumb-up-down zmdi-hc-fw fa-fw"></i> <span
                                class="hide-menu">Mes Appréciations</span></a></li>
                <li><a href="{{ url('teacher/absences') }}" class="waves-effect"><i
                                class="zmdi zmdi-shield-check zmdi-hc-fw fa-fw"></i> <span
                                class="hide-menu">Absences / Retards</span></a></li>

                @if (Auth::user()->hasRole("headmaster"))
                    <li><a href="{{ url('teacher/schools') }}" class="waves-effect"><i
                                    class="zmdi zmdi-graduation-cap zmdi-hc-fw fa-fw"></i> <span
                                    class="hide-menu">Mes écoles</span></a></li>
                @endif

                <li class="nav-small-cap">-- Mon compte</li>
                <li><a href="{{ url('teacher/invites') }}" class="waves-effect"><i
                                class="zmdi zmdi-account-add zmdi-hc-fw fa-fw"></i>
                        <span class="hide-menu">Invitations</span></a></li>
                <li><a href="{{ url('teacher/settings') }}" class="waves-effect"><i
...
<script src="/teacheroffice/js/custom.js"></script>
